            ...
            return (
                <div className="flex flex-col gap-2">
                    ...
                    <input
                        ...
                        placeholder={placeholder}
                        value={value}
                        className="py-[7px] px-[30px] rounded-full border border-orangePrimary text-orangePrimary bg-blackPrimary placeholder:text-orangePrimary placeholder:opacity-30 focus:outline-none focus:border-whitePrimary"
                    />
                </div>
            );
    }
